...
{
	// Pipe erstellen, welche die Daten¸bertragung von pscan.dll zum Hack ¸bernimmt
	...
	// F¸r jeden Address-Eintrag
	for (unsigned int i = 0; i < m_vecAddresses.size(); i++)
	{
		// Wenn der Eintrag gar keine Signatur besitzt, dann einfach ¸berspringen und als gefunden ansehen
		...
		// Loader in Process laden, der dann die Funktion findPattern in der DLL pscan.dll ausf¸hrt mit dem parameter des Eintrags
